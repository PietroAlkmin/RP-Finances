/**
 * Script de teste rápido para integração Binance
 */

// Carregar variáveis de ambiente primeiro
import 'dotenv/config';

import { BinanceInvestmentCollector } from './dist/ts/integrations/binance/BinanceInvestmentCollector.js';
import { BINANCE_CONFIG, validateBinanceConfig } from './dist/config/binance.js';

async function testeRapido() {
  console.log('🚀 === TESTE RÁPIDO BINANCE ===\n');
